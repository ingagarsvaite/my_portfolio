...
class Media(models.Model):
    ...
    # o ka suniux dara sitam kuode XD
...
class Portfolio(models.Model):
    ...
    body = RichTextField(blank=True, null=True) # o kodėl čia nėra mnodels pradžioj?
    slug = models.ImageField(blank=True, null=True, upload_to="portfolio")
    is_active = models.BooleanField(default=True)
